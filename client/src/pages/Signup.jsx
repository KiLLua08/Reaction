...
function Signup() {
  return (
    ...
    <div className="m-2 max-w-screen m-0 p-2 sm:m-40 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div className="lg:w-1/2 sm:w-5/12 p-6 sm:p-12">
            <div>
                <img src="{straw}" className="w-mx-auto" />
            </div>
